...
cost_data <- read_excel("C:/Users/Person/Desktop/MHD_BIOC492_HackathonData_072020NYCMTAJuly2014.xlsx", sheet = "Sheet2")
...
rider_data <- read_excel("C:/Users/Person/Desktop/MHD_BIOC492_HackathonData_072020NYCMTAJuly2014.xlsx", sheet = "Sheet1", n_max = 31)
...
#QUESTION 2 
    ...
    ggplot(data=cost_data, aes(x = `MTA Station`, y = Mean)) +
      ...
      geom_hline(aes(fill = `MTA Station`), yintercept = 2.5, linetype = 2, size = 2)+
    ...
    #Create a scatterplot to assess a(ny) relationship between Pizza Cost and Transit user count
